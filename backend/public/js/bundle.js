  ...
  async renderBooks() {
    ...
    books.forEach((book) => {
      ...
      div.innerHTML = `
                ...
                <div class= "row">                
                    <div class= "col-md-4">
                    <img class="img-fuid" src="http://localhost:2000${book.imagePath}" alt="image">
                    </div>
                    <div class= "col-md-8">
                ...
                ${Object(timeago_js__WEBPACK_IMPORTED_MODULE_1__["format"])(book.crated_at)}
                </div>
                </div>
            `;
...
/* harmony import */ var morgan__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! morgan */ "./node_modules/morgan/index.js");
...
class BookService{
    constructor(){
        this.URI = 'http://localhost:2000/api/books';
    }
    //consultar books
    async getBooks(){
